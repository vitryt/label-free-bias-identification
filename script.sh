...
do
    ...
    python model_training.py --model_id $model_id --model_name $model --epochs 80 --split_seed ${random_seeds[$model_id]} --shuffle_seed ${random_seeds[$model_id]} --gpu_id $gpu_id --result_path $result_path --data_path $data_path
