# Script for identifying the bias in the biased CMNIST models using differently biased audit
...
do
    ...
    do
        ...
        do
            ...
            python bias_identifying.py --model_id $model_id --model_name $model_name --experiment_name $experiment_name --number_of_concept $number_of_concept  --patch_size $patch_size --gpu_id $gpu_id --result_path $result_path --data_path $data_path --change_bias
