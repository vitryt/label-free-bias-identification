...
declare -a number_of_concepts=( 10 )
declare -a patch_sizes=( 50 )
dataset="CelebA"
model_type="resnetceleb"
model_name="CelebA"
experiment_name="b"
optimizer="sgd"
gpu_id="0"
...
do
    ...
    python model_training.py --model_id $model_id --model_name $model_name --batch_size 128 --epochs 20 --split_seed ${random_seeds[$model_id]} --shuffle_seed ${random_seeds[$model_id]} --gpu_id $gpu_id --result_path $result_path --data_path $data_path --dataset $dataset --model_type $model_type --optimizer $optimizer --lr_decrease_factor 1 --lr_decrease_frequency 1000
